...
public class AbstractSyntaxTree {
    ...
    /**
     * Inserts a new value as children of the given node with addition, multiplication,
     * and concatenation edges.
     *
    ...
    public void insert(Node node, long newNodeValue) {
        ...
        node.setNodeToConcatenate(new Node(newNodeValue));
    }
    ...
    public List<Node> dfsVisitGetAllNodes(Node node) {
        ...
        if (node.getNodeToConcatenate() != null)
            nodes.addAll(dfsVisitGetAllNodes(node.getNodeToConcatenate()));
     ...
     * by applying addition, multiplication, and concatenation operators.
     *
    ...
    public List<Long> getAllPossibleEquationsResults(long calculatedValue, Node node) {
        ...
        result.addAll(getAllPossibleEquationsResults(Long.parseLong(calculatedValue + "" + node.getValue()), node.getNodeToConcatenate()));
    ...
    public List<Node> getAllLeafs() {
        ...
        leafs = allNodes.stream()
                        .filter(n -> n.getNodeToAdd() == null && n.getNodeToMultiply() == null && n.getNodeToConcatenate() == null)
